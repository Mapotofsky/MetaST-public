...
from models.deeptime.modules.inr import INR
from models.deeptime.modules.regressors import RidgeRegressor
...
class DeepTIMe(nn.Module):
    ...
    def forward(self, x_seen, x: Tensor, target_idx, x_time: Tensor, y_time: Tensor) -> Tensor:
