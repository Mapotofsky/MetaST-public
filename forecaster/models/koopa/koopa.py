...
@gin.configurable()
def koopa(mask_spectrum, enc_in, seq_len, pred_len, seg_len, num_blocks, dynamic_dim, hidden_dim, hidden_layers, multistep):
    class KoopaConfig:
        def __init__(self, mask_spectrum, enc_in, seq_len, pred_len, seg_len,
                     num_blocks, dynamic_dim, hidden_dim, hidden_layers, multistep):
    ...
    configs = KoopaConfig(mask_spectrum, enc_in, seq_len, pred_len, seg_len,
                          num_blocks, dynamic_dim, hidden_dim, hidden_layers, multistep)
    return Koopa(configs)
...
class Koopa(nn.Module):
    ...
    def forward(self, support, x_enc, target_idx, x_time, y_time):
        # x_enc: B L C
