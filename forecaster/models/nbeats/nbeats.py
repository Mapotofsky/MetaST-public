...
@gin.configurable()
def nbeats(device, nb_blocks_per_stack: int, forecast_length: int, backcast_length: int, hidden_layer_units: int):
    return NBeatsNet(
        device=device,
...
class NBeatsNet(nn.Module):
    ...
    def forward(self, support, backcast, target_idx, x_time, y_time):
        self._intermediary_outputs = []
